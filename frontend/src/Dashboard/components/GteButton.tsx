  ...
  return (
    <StyledButton {...props}>
      <svg
        ...
        viewBox="0 0 512 512"
        focusable="false"
        style={{ fill: "palegoldenrod", height: "36px", width: "36px" }}
      >
        <path
        ...
        />
        <path
          d="M365.428,186.42L226.267,94.11c-7.686-5.098-18.049-3-23.147,4.685c-5.098,7.686-3,18.049,4.685,23.147l118.181,78.393
			l-118.181,78.393c-7.686,5.098-9.784,15.461-4.685,23.147c5.098,7.685,15.461,9.784,23.147,4.685l139.161-92.309
			c4.652-3.086,7.468-8.333,7.468-13.916S370.081,189.506,365.428,186.42z"
        />
        <path
